...
import type { PurchaseLineItemResult } from "./AddPurchaseItemDialog";
...
export interface PurchaseOrderItemsDraftSectionHandle {
...
interface PurchaseOrderItemsDraftSectionProps {
...
const PurchaseOrderItemsDraftSection = forwardRef<
  PurchaseOrderItemsDraftSectionHandle,
  PurchaseOrderItemsDraftSectionProps
>(({ onTotalsChange }, ref) => {
  ...
  const handleAdd = (result: PurchaseLineItemResult) => {
...
PurchaseOrderItemsDraftSection.displayName = "PurchaseOrderItemsDraftSection";

export default PurchaseOrderItemsDraftSection;
