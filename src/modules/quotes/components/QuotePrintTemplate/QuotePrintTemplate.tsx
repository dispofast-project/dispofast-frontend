...
export interface QuotePrintTemplateProps {
  quoteNumber: string;
  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div>
            <div style={{ fontWeight: "bold", color: PRIMARY, fontSize: 14 }}>{clientName}</div>
            {identificationNumber && (
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ marginTop: 2 }}>
              <span style={{ fontSize: 12, color: "#555" }}>cotización # </span>
              <span style={{ fontWeight: "bold", fontSize: 20, color: "#222" }}>{quoteNumber}</span>
            </div>
            {isDraft && (
              <div
                style={{
        ...
        <div style={{ marginBottom: 20 }}>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                <InfoCell label="Nombre" value={clientName} />
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <tbody>
              <tr>
                ...
                <InfoCell label="Validez de la oferta" value={offerValidity ?? "No aplica"} />
                <InfoCell
