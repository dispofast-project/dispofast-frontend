...
interface Props {
  data: AsesorVsQuotaStats[];
  loading: boolean;
}

const AsesorVsQuotaChart = ({ data, loading }: Props) => {
  ...
  return (
    <Paper elevation={0} className="rounded-xl border border-gray-100 p-6">
      <p className="text-sm font-semibold text-gray-700 mb-4">Ventas vs. Cuota</p>
        ...
        <>
          <ResponsiveContainer width="100%" height={chartHeight}>
            ...
            >
              ...
              <Bar dataKey="Ventas" fill="#22c55e" radius={[0, 3, 3, 0]} barSize={10} />
            </BarChart>
          </ResponsiveContainer>
          ...
          <CustomTable
            headers={["Asesor", "Mes", "Ventas", "Cuota", "% Cumpl."]}
