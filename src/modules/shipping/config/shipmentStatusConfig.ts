...
export const VALID_STATE_TRANSITIONS: Record<ShipmentState, ShipmentState[]> = {
  PENDING: ["ASSIGNED", "IN_ROUTE", "DELIVERED", "DELAYED"],
  ASSIGNED: ["PENDING", "IN_ROUTE", "DELIVERED", "DELAYED"],
  IN_ROUTE: ["PENDING", "ASSIGNED", "DELIVERED", "DELAYED"],
  DELIVERED: [],
  DELAYED: ["PENDING", "ASSIGNED", "IN_ROUTE", "DELIVERED"],
};
