            ...
            <Route element={<ProtectedRoute />}>
                <Route element={<MainLayout />}>
                    ...
                    <Route path="/cotizaciones" element={
                        <div className="p-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-4">Cotizaciones</h1>
                        </div>
                    } />
                    <Route path="/cartera" element={
                        <div className="p-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-4">Cartera</h1>
                        </div>
                    } />
                    ...
                    <Route path="/despachos" element={
                        <div className="p-6">
                            <h1 className="text-3xl font-bold text-gray-800 mb-4">Despachos</h1>
                        </div>
                    } />
